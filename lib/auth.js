...
// Always resolves the user against the DB so role, ban status, and
// verification state reflect the current record rather than a
// potentially stale JWT payload.
