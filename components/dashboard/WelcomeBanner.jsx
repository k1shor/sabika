  ...
  return (
    <motion.div variants={fadeUp} className="relative overflow-hidden rounded-3xl shadow-md">
      ...
      <div className="relative px-8 py-10">
        ...
        <p className="mt-2 text-sm text-slate-600">Your nursing community in Nepal awaits.</p>
        <div className="mt-6 flex gap-3">
          <Link href="/blogs" className="rounded-xl bg-[#E35D6A] px-5 py-2 text-sm font-bold text-white hover:bg-[#d14c59]">
            Browse Articles
          </Link>
          <Link href="/writers/posts" className="rounded-xl border border-slate-300 px-5 py-2 text-sm font-bold text-slate-700 hover:bg-white/60">
            Write new post
          </Link>
        </div>
      </div>
